...
def write(memberNames, memberLSToons):
    wb = openpyxl.Workbook()
    lightToonsNames = []
    sheet = wb.active
    sheet.title = 'LSToons'
    lightToonsNames = getCharacterNames(memberLSToons)
    writeMemberNames(memberNames, sheet)
    writeCharacterNames(lightToonsNames, sheet)
    writeLevels(memberLSToons, lightToonsNames, memberNames, sheet)
